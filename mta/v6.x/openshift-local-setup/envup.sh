...
sleep 60
oc delete clusterserviceversion mta-operator.v6.2.2 -n openshift-mta

sleep 120
while true; do
    OPERATOR_INSTALLED=$(oc get clusterserviceversions/mta-operator.v6.2.2 | grep Succeeded)
